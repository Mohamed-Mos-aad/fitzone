    ...
    return (
        <nav className="bg-[#0A0C0E]/90 border-b border-[#222720] py-4 px-6 lg:px-12 flex items-center justify-between relative">
            ...
            <button 
                ...
                className="lg:hidden text-white focus:outline-none p-2 rounded-lg hover:bg-[#222720]/50 transition-colors z-50"
            ...
            <div className={`absolute top-full left-0 w-full bg-[#0A0C0E] border-b border-[#222720] flex flex-col items-center gap-6 py-6 transition-all duration-300 lg:hidden ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
